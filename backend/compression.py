...
class VBEPostings:
    ...
    def vb_decode(encoded_bytestream):
        ...
        Reference:
        [1] https://github.com/utahta/pyvbcode/blob/master/vbcode.py
        """
        numbers = []
        n = 0
    ...
    def decode(encoded_postings_list):
        ...
        original_list = [decoded_posting_list[0]]

        for i in range(1, len(decoded_posting_list)):
            original_list.append(decoded_posting_list[i] + original_list[i - 1])
